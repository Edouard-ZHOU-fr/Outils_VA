...
def enregistement_traj(r_rosbag,r_sorite):
    ...
    global processe1
    processe1 = subprocess.Popen(c_rosbag, shell=True, stdout=subprocess.PIPE) 
    time.sleep(5)
...
def valider():
    global frequence
    # global progressbar1
    # progressbar1 = tkinter.ttk.Progressbar(window, length=500, mode='indeterminate', orient=tkinter.HORIZONTAL)
